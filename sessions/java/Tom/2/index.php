        ...
        <article class="articleFull">
          ...
          <section class="splitContent">
            ...
            <section id="sessionsMain">
              ...
              <h1>30th May 2015 - Classes</h1>

              <p>The <a href="CoderDoJo_Week2.zip">full NetBeans project</a> that consists of the following: </p>
                
              <div>
                <ul>
                  <li>main</li>
                  <li>Class that consists of properties, methods, functions and also combines for loop with String class manipulation.</li>
                </ul>
              </div>
