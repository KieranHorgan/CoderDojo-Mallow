        ...
        <article class="articleFull">
          ...
          <section class="splitContent">
            ...
            <section id="sessionsMain">
              ...
              <h1>20th June 2015 - Classes</h1>

<p>The <a href="CoderDoJo_Week5.zip">Full NetBeans project</a></p>

              <p>We will focus on more OOP principles, namely <b>Interfaces</b> which is how events are created and is the key to understanding how get notified of applicable events from elsewhere.</p>
                
              <div>
                <ul>
                  <li>Interfaces</li>
                  <li>Callbacks/Events</li>
                  <li>Multiple <i>main</i> classes.</li>
                </ul>
              </div>
            <p>Stay tuned. </p>
            </section><!--
