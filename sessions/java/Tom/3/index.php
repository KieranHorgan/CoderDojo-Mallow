        ...
        <article class="articleFull">
          ...
          <section class="splitContent">
            ...
            <section id="sessionsMain">
              ...
              <h1>6th June 2015 - Classes</h1>

              <p>The <a href="CoderDoJo_Week2_1.zip">full NetBeans project</a> that consists of the following: </p>
                
              <div>
                <ul>
                  <li>main</li>
                  <li>Class and inheritance in Object Oriented Programming (<b><i>OOP</i></b>) style.</li>
                </ul>
              </div>
